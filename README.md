...
<body>
            ...
            <div class="row text-center">
                <div class="col-md-4">
                    <div class="card border-0">
                        <img src="1.jpg" class="card-img-top" alt="Latest News">
                        <div class="card-body">
                ...
                <div class="col-md-4">
                    <div class="card border-0">
                        <img src="2.jpg" class="card-img-top" alt="Top Reviews">
                        <div class="card-body">
                ...
                <div class="col-md-4">
                    <div class="card border-0">
                        <img src="3.jpg" class="card-img-top" alt="Community">
                        <div class="card-body">
    ...
    <section id="games" class="bg-light py-5">
        <div class="container">
            ...
            <div class="row">
                <div class="col-md-4">
                    <div class="card">
                        <img src="4.jpg" class="card-img-top" alt="Game 1">
                        <div class="card-body">
                ...
                <div class="col-md-4">
                    <div class="card">
                        <img src="5.jpg" class="card-img-top" alt="Game 2">
                        <div class="card-body">
                ...
                <div class="col-md-4">
                    <div class="card">
                        <img src="6.jpg" class="card-img-top" alt="Game 3">
                        <div class="card-body">
    ...
    <footer class="bg-dark text-white text-center py-3">
        <div class="container">
            <p class="mb-0">&copy; 2024 Organised By S.Star Ashil</p>
        </div>
    </footer>
